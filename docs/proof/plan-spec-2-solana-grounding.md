...
- [ ] **Step 3: Per-question, 3 conditions** (use `withOwnerWallet(BENCHMARK_WALLET, () => recallMemories({ query: question, limit: 10, skipExpansion: true }))`):
