import{r as t,ai as B,a8 as D,af as q,bI as V,c1 as F,j as r,c2 as h,ab as x,c3 as K,aB as z,bJ as E}from"./vendor-privy-D-qEdLrY.js";import{F as X}from"./EnvelopeIcon-BSHSdkr_.js";import{F as Y}from"./PhoneIcon-B-vAayHS.js";import{o as H}from"./Layouts-BlFm53ED-ChItRmlQ.js";import{n as J}from"./Link-DJ5gq9Di-C1JwVBE2.js";import{a as Q}from"./shouldProceedtoEmbeddedWalletCreationFlow-D2ZT5lW9-IY6Fb4St.js";import{n as Z}from"./ScreenLayout-D1p_ntex-gpRu1-Ng.js";import"./ModalHeader-BnVmXtvG-nKy1GoVW.js";import"./Screen-Cycy3IzT-wOMWdYJj.js";import"./index-Dq_xe9dz-uQVzNJLN.js";function G({title:o,titleId:d,...y},u){return t.createElement("svg",Object.assign({xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 20 20",fill:"currentColor","aria-hidden":"true","data-slot":"icon",ref:u,"aria-labelledby":d},y),o?t.createElement("title",{id:d},o):null,t.createElement("path",{fillRule:"evenodd",d:"M16.704 4.153a.75.75 0 0 1 .143 1.052l-8 10.5a.75.75 0 0 1-1.127.075l-4.5-4.5a.75.75 0 0 1 1.06-1.06l3.894 3.893 7.48-9.817a.75.75 0 0 1 1.05-.143Z",clipRule:"evenodd"}))}const ee=t.forwardRef(G),re=({contactMethod:o,authFlow:d,appName:y="Privy",whatsAppEnabled:u=!1,onBack:k,onCodeSubmit:b,onResend:j,errorMessage:p,success:w=!1,resendCountdown:S=0,onInvalidInput:I,onClearError:N})=>{let[f,g]=t.useState(U);t.useEffect((()=>{p||g(U)}),[p]);let M=async i=>{i.preventDefault();let n=i.currentTarget.value.replace(" ","");if(n==="")return;if(isNaN(Number(n)))return void I?.("Code should be numeric");N?.();let s=Number(i.currentTarget.name?.charAt(5)),l=[...n||[""]].slice(0,P-s),m=[...f.slice(0,s),...l,...f.slice(s+l.length)];g(m);let c=Math.min(Math.max(s+l.length,0),P-1);isNaN(Number(i.currentTarget.value))||document.querySelector(`input[name=code-${c}]`)?.focus(),m.every((v=>v&&!isNaN(+v)))&&(document.querySelector(`input[name=code-${c}]`)?.blur(),await b?.(m.join("")))};return r.jsx(Z,{title:"Enter confirmation code",subtitle:r.jsxs("span",d==="email"?{children:["Please check ",r.jsx(W,{children:o})," for an email from privy.io and enter your code below."]}:{children:["Please check ",r.jsx(W,{children:o})," for a",u?" WhatsApp":""," message from ",y," and enter your code below."]}),icon:d==="email"?X:Y,onBack:k,showBack:!0,helpText:r.jsxs(se,{children:[r.jsxs("span",{children:["Didn't get ",d==="email"?"an email":"a message","?"]}),S?r.jsxs(le,{children:[r.jsx(ee,{color:"var(--privy-color-foreground)",strokeWidth:1.33,height:"12px",width:"12px"}),r.jsx("span",{children:"Code sent"})]}):r.jsx(J,{as:"button",size:"sm",onClick:j,children:"Resend code"})]}),children:r.jsx(te,{children:r.jsx(H,{children:r.jsxs(ne,{children:[r.jsx("div",{children:f.map(((i,n)=>r.jsx("input",{name:`code-${n}`,type:"text",value:f[n],onChange:M,onKeyUp:s=>{s.key==="Backspace"&&(l=>{N?.(),g([...f.slice(0,l),"",...f.slice(l+1)]),l>0&&document.querySelector(`input[name=code-${l-1}]`)?.focus()})(n)},inputMode:"numeric",autoFocus:n===0,pattern:"[0-9]",className:`${w?"success":""} ${p?"fail":""}`,autoComplete:z.isMobile?"one-time-code":"off"},n)))}),r.jsx(ie,{$fail:!!p,$success:w,children:r.jsx("span",{children:p==="Invalid or expired verification code"?"Incorrect code":p||(w?"Success!":"")})})]})})})})};let P=6,U=Array(6).fill("");var A,T,oe=((A=oe||{})[A.RESET_AFTER_DELAY=0]="RESET_AFTER_DELAY",A[A.CLEAR_ON_NEXT_VALID_INPUT=1]="CLEAR_ON_NEXT_VALID_INPUT",A),ae=((T=ae||{})[T.EMAIL=0]="EMAIL",T[T.SMS=1]="SMS",T);const Ee={component:()=>{let{navigate:o,lastScreen:d,navigateBack:y,setModalData:u,onUserCloseViaDialogOrKeybindRef:k}=B(),b=D(),{closePrivyModal:j,resendEmailCode:p,resendSmsCode:w,getAuthMeta:S,loginWithCode:I,updateWallets:N,createAnalyticsEvent:f}=q(),{authenticated:g,logout:M,user:i}=V(),{whatsAppEnabled:n}=D(),[s,l]=t.useState(!1),[m,c]=t.useState(null),[v,C]=t.useState(null),[_,L]=t.useState(0);k.current=()=>null;let R=S()?.email?0:1,$=R===0?S()?.email||"":S()?.phoneNumber||"",O=F-500;return t.useEffect((()=>{if(_){let a=setTimeout((()=>{L(_-1)}),1e3);return()=>clearTimeout(a)}}),[_]),t.useEffect((()=>{if(g&&s&&i){if(b?.legal.requireUsersAcceptTerms&&!i.hasAcceptedTerms){let a=setTimeout((()=>{o("AffirmativeConsentScreen")}),O);return()=>clearTimeout(a)}if(Q(i,b.embeddedWallets)){let a=setTimeout((()=>{u({createWallet:{onSuccess:()=>{},onFailure:e=>{console.error(e),f({eventName:"embedded_wallet_creation_failure_logout",payload:{error:e,screen:"AwaitingPasswordlessCodeScreen"}}),M()},callAuthOnSuccessOnClose:!0}}),o("EmbeddedWalletOnAccountCreateScreen")}),O);return()=>clearTimeout(a)}{N();let a=setTimeout((()=>j({shouldCallAuthOnSuccess:!0,isSuccess:!0})),F);return()=>clearTimeout(a)}}}),[g,s,i]),t.useEffect((()=>{if(m&&v===0){let a=setTimeout((()=>{c(null),C(null),document.querySelector("input[name=code-0]")?.focus()}),1400);return()=>clearTimeout(a)}}),[m,v]),r.jsx(re,{contactMethod:$,authFlow:R===0?"email":"sms",appName:b?.name,whatsAppEnabled:n,onBack:()=>y(),onCodeSubmit:async a=>{try{await I(a),l(!0)}catch(e){if(e instanceof h&&e.privyErrorCode===x.INVALID_CREDENTIALS)c("Invalid or expired verification code"),C(0);else if(e instanceof h&&e.privyErrorCode===x.CANNOT_LINK_MORE_OF_TYPE)c(e.message);else{if(e instanceof h&&e.privyErrorCode===x.USER_LIMIT_REACHED)return console.error(new K(e).toString()),void o("UserLimitReachedScreen");if(e instanceof h&&e.privyErrorCode===x.USER_DOES_NOT_EXIST)return void o("AccountNotFoundScreen");if(e instanceof h&&e.privyErrorCode===x.LINKED_TO_ANOTHER_USER)return u({errorModalData:{error:e,previousScreen:d??"AwaitingPasswordlessCodeScreen"}}),void o("ErrorScreen",!1);if(e instanceof h&&e.privyErrorCode===x.DISALLOWED_PLUS_EMAIL)return u({inlineError:{error:e}}),void o("ConnectOrCreateScreen",!1);if(e instanceof h&&e.privyErrorCode===x.ACCOUNT_TRANSFER_REQUIRED&&e.data?.data?.nonce)return u({accountTransfer:{nonce:e.data?.data?.nonce,account:$,displayName:e.data?.data?.account?.displayName,linkMethod:R===0?"email":"sms",embeddedWalletAddress:e.data?.data?.otherUser?.embeddedWalletAddress}}),void o("LinkConflictScreen");c("Issue verifying code"),C(0)}}},onResend:async()=>{L(30),R===0?await p():await w()},errorMessage:m||void 0,success:s,resendCountdown:_,onInvalidInput:a=>{c(a),C(1)},onClearError:()=>{v===1&&(c(null),C(null))}})}};let te=E.div`
  display: flex;
