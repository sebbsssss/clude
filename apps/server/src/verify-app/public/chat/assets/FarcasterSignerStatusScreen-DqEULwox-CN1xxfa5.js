import{ai as F,a8 as T,af as I,r as c,c1 as y,j as t,aB as x,cj as B,bJ as o}from"./vendor-privy-D-qEdLrY.js";import{h as O}from"./CopyToClipboard-DSTf_eKU-CyeC66_n.js";import{n as q}from"./OpenLink-DZHy38vr-B0b6J2XH.js";import{C as E}from"./QrCode-B84kEIjT-BeRohmiA.js";import{n as M}from"./ScreenLayout-D1p_ntex-gpRu1-Ng.js";import{l as h}from"./farcaster-DPlSjvF5-DfmS1E9n.js";import"./dijkstra-COg3n3zL.js";import"./ModalHeader-BnVmXtvG-nKy1GoVW.js";import"./Screen-Cycy3IzT-wOMWdYJj.js";import"./index-Dq_xe9dz-uQVzNJLN.js";let S="#8a63d2";const _=({appName:u,loading:m,success:p,errorMessage:e,connectUri:a,onBack:r,onClose:l,onOpenFarcaster:s})=>t.jsx(M,x.isMobile||m?x.isIOS?{title:e?e.message:"Add a signer to Farcaster",subtitle:e?e.detail:`This will allow ${u} to add casts, likes, follows, and more on your behalf.`,icon:h,iconVariant:"loading",iconLoadingStatus:{success:p,fail:!!e},primaryCta:a&&s?{label:"Open Farcaster app",onClick:s}:void 0,onBack:r,onClose:l,watermark:!0}:{title:e?e.message:"Requesting signer from Farcaster",subtitle:e?e.detail:"This should only take a moment",icon:h,iconVariant:"loading",iconLoadingStatus:{success:p,fail:!!e},onBack:r,onClose:l,watermark:!0,children:a&&x.isMobile&&t.jsx(A,{children:t.jsx(q,{text:"Take me to Farcaster",url:a,color:S})})}:{title:"Add a signer to Farcaster",subtitle:`This will allow ${u} to add casts, likes, follows, and more on your behalf.`,onBack:r,onClose:l,watermark:!0,children:t.jsxs(P,{children:[t.jsx(R,{children:a?t.jsx(E,{url:a,size:275,squareLogoElement:h}):t.jsx(V,{children:t.jsx(B,{})})}),t.jsxs(L,{children:[t.jsx(N,{children:"Or copy this link and paste it into a phone browser to open the Farcaster app."}),a&&t.jsx(O,{text:a,itemName:"link",color:S})]})]})});let A=o.div`
  margin-top: 24px;
`,P=o.div`
  display: flex;
