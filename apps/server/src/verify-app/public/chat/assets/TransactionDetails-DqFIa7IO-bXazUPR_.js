import{j as e,d5 as p,a8 as P,r as d,bJ as r}from"./vendor-privy-D-qEdLrY.js";import{p as S,v as u,h as v}from"./WalletLink-DNbGmOPX-lJvUkZie.js";import{c as g}from"./ethers-Dnv1tMN3-B8croYaS.js";import{d as f}from"./Layouts-BlFm53ED-ChItRmlQ.js";import{F as I}from"./ChevronDownIcon-DrDFPRf0.js";const h=({label:i,children:n,valueStyles:t})=>e.jsxs(C,{children:[e.jsx("div",{children:i}),e.jsx(B,{style:{...t},children:n})]});let C=r.div`
  display: flex;
  align-items: center;
...
`;const X=({from:i,to:n,txn:t,transactionInfo:o,tokenPrice:l,gas:c,tokenSymbol:x})=>{let w=BigInt(t?.value||0);return e.jsx(T,{...P().render.standalone?{defaultValue:"details"}:{},children:e.jsxs(z,{value:"details",children:[e.jsx($,{children:e.jsxs(q,{children:[e.jsx("div",{children:o?.title||"Details"}),e.jsx(G,{children:e.jsx(S,{weiQuantities:[w],tokenPrice:l,tokenSymbol:x})})]})}),e.jsxs(E,{children:[e.jsx(h,{label:"From",children:e.jsx(u,{walletAddress:i,chainId:t.chainId||p,chainType:"ethereum"})}),e.jsx(h,{label:"To",children:e.jsx(u,{walletAddress:n,chainId:t.chainId||p,chainType:"ethereum"})}),o&&o.action&&e.jsx(h,{label:"Action",children:o.action}),c&&e.jsx(A,{value:t.value,gas:c,tokenPrice:l,tokenSymbol:x})]}),e.jsx(Q,{children:({isActive:k})=>e.jsx(F,{value:t.value,displayFee:k,gas:c||"0x0",tokenPrice:l,tokenSymbol:x})})]})})};let q=r.div`
  display: flex;
  flex-direction: row;
  justify-content: space-between;
`,G=r.div`
