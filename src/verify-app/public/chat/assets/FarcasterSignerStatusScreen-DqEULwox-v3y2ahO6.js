import{P as F,c as T,I,r as c,bd as y,j as t,F as x,bv as O,aV as o}from"./vendor-privy-DtunxRQf.js";import{h as q}from"./CopyToClipboard-DSTf_eKU-BA7yvUCu.js";import{n as B}from"./OpenLink-DZHy38vr-_fUoIzeO.js";import{C as E}from"./QrCode-B84kEIjT-CjwwAmGi.js";import{n as M}from"./ScreenLayout-D1p_ntex-BYJDImRj.js";import{l as h}from"./farcaster-DPlSjvF5-Cw7fIJbf.js";import"./dijkstra-COg3n3zL.js";import"./ModalHeader-BnVmXtvG-CidjF2-W.js";import"./Screen-Cycy3IzT-BrkGy7CI.js";import"./index-Dq_xe9dz-N_qhxTGL.js";let S="#8a63d2";const _=({appName:u,loading:m,success:d,errorMessage:e,connectUri:a,onBack:r,onClose:l,onOpenFarcaster:s})=>t.jsx(M,x.isMobile||m?x.isIOS?{title:e?e.message:"Add a signer to Farcaster",subtitle:e?e.detail:`This will allow ${u} to add casts, likes, follows, and more on your behalf.`,icon:h,iconVariant:"loading",iconLoadingStatus:{success:d,fail:!!e},primaryCta:a&&s?{label:"Open Farcaster app",onClick:s}:void 0,onBack:r,onClose:l,watermark:!0}:{title:e?e.message:"Requesting signer from Farcaster",subtitle:e?e.detail:"This should only take a moment",icon:h,iconVariant:"loading",iconLoadingStatus:{success:d,fail:!!e},onBack:r,onClose:l,watermark:!0,children:a&&x.isMobile&&t.jsx(A,{children:t.jsx(B,{text:"Take me to Farcaster",url:a,color:S})})}:{title:"Add a signer to Farcaster",subtitle:`This will allow ${u} to add casts, likes, follows, and more on your behalf.`,onBack:r,onClose:l,watermark:!0,children:t.jsxs(P,{children:[t.jsx(R,{children:a?t.jsx(E,{url:a,size:275,squareLogoElement:h}):t.jsx(N,{children:t.jsx(O,{})})}),t.jsxs(V,{children:[t.jsx(L,{children:"Or copy this link and paste it into a phone browser to open the Farcaster app."}),a&&t.jsx(q,{text:a,itemName:"link",color:S})]})]})});let A=o.div`
  margin-top: 24px;
`,P=o.div`
  display: flex;
