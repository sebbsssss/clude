import{cO as d,d7 as s}from"./index-7Y6H6yFI.js";let c=s.a`
  && {
...
`;const p=({size:r="md",variant:e="navigation",disabled:o=!1,as:i,children:a,onClick:t,...l})=>d.jsx(c,{as:i,$size:r,$variant:e,$disabled:o,onClick:n=>{o?n.preventDefault():t?.(n)},...l,children:a});export{p as n};
