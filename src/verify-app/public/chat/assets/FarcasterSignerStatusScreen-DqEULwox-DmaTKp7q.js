import{da as F,db as T,dc as I,de as c,dB as w,d4 as t,dD as x,dy as B,dx as o}from"./index-l91PVMT7.js";import{h as O}from"./CopyToClipboard-DSTf_eKU-BKw0kSBy.js";import{n as q}from"./OpenLink-DZHy38vr-Czyrj9II.js";import{C as E}from"./QrCode-B84kEIjT-CN221TTY.js";import{n as M}from"./ScreenLayout-D1p_ntex-B3Nwe3ZC.js";import{l as h}from"./farcaster-DPlSjvF5-63-ZzNix.js";import"./dijkstra-COg3n3zL.js";import"./ModalHeader-BnVmXtvG-BbPQjodo.js";import"./Screen-Cycy3IzT-D1vgF4Ou.js";import"./index-Dq_xe9dz-B89WBFCw.js";let S="#8a63d2";const _=({appName:d,loading:m,success:u,errorMessage:e,connectUri:a,onBack:r,onClose:l,onOpenFarcaster:s})=>t.jsx(M,x.isMobile||m?x.isIOS?{title:e?e.message:"Add a signer to Farcaster",subtitle:e?e.detail:`This will allow ${d} to add casts, likes, follows, and more on your behalf.`,icon:h,iconVariant:"loading",iconLoadingStatus:{success:u,fail:!!e},primaryCta:a&&s?{label:"Open Farcaster app",onClick:s}:void 0,onBack:r,onClose:l,watermark:!0}:{title:e?e.message:"Requesting signer from Farcaster",subtitle:e?e.detail:"This should only take a moment",icon:h,iconVariant:"loading",iconLoadingStatus:{success:u,fail:!!e},onBack:r,onClose:l,watermark:!0,children:a&&x.isMobile&&t.jsx(A,{children:t.jsx(q,{text:"Take me to Farcaster",url:a,color:S})})}:{title:"Add a signer to Farcaster",subtitle:`This will allow ${d} to add casts, likes, follows, and more on your behalf.`,onBack:r,onClose:l,watermark:!0,children:t.jsxs(P,{children:[t.jsx(R,{children:a?t.jsx(E,{url:a,size:275,squareLogoElement:h}):t.jsx(N,{children:t.jsx(B,{})})}),t.jsxs(D,{children:[t.jsx(L,{children:"Or copy this link and paste it into a phone browser to open the Farcaster app."}),a&&t.jsx(O,{text:a,itemName:"link",color:S})]})]})});let A=o.div`
  margin-top: 24px;
`,P=o.div`
  display: flex;
