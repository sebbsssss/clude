...
export const VECTOR_MATCH_THRESHOLD = 0.15;             // Min cosine similarity — must be low enough for question→answer matching (Q: "What framework?" has ~0.21 sim with A: "Next.js 14")
...
export const BOND_TYPE_WEIGHTS: Record<MemoryLinkType, number> = {
  causes:          1.0,
  supports:        0.9,
  supersedes:      0.85,  // decisive replacement: new fact overrides an older one (Memory 3.0 C1)
  concurrent_with: 0.8,
  resolves:        0.8,
  happens_before:  0.7,
  happens_after:   0.7,
